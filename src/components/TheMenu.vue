        ...
        <section class="mx-auto mt-16 px-4 sm:mt-24">
          <div class="flex flex-col md:flex-row">
            <div class="text-center md:text-left flex-1">
              ...
              <div class="mt-5 flex flex-col justify-center items-center gap-3 md:flex-row md:justify-start md:mt-8">
                <div class="rounded-md w-fit shadow">
                  <a href="#" class="flex  items-center justify-center rounded-full border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-700 md:py-4 md:px-10 md:text-lg">Comece agora</a>
                </div>
                <div class="rounded-md w-fit shadow">
                  <a href="#" class="flex  items-center justify-center rounded-full border border-solid border-white text-white px-8 py-3 text-base font-medium md:py-4 md:px-10 md:text-lg">Saiba mais</a>
                </div>
              </div>
            </div>
